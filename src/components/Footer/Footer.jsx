...
const Footer = () => {
  return (
    <footer class="footer footer-horizontal footer-center  p-10">
      <aside>
        <img src={AuctionGallery} alt="" srcset="" />
        <ul className="menu menu-horizontal font-sora">
          <li>
            <a className="text-2xl">Bid.</a>
          </li>
          <li>
            <a className="text-2xl">Win.</a>
          </li>
          <li>
            <a className="text-2xl">Own.</a>
          </li>
        </ul>
        <ul className="menu menu-horizontal font-poppins">
          <li>
